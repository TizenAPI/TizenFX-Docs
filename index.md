...
<div class="table-responsive table-infra">
    <table class="table table-bordered table-striped table-condensed">
        ...
        <tbody>
            <tr>
                <td style="text-align:center"><a href="./API15/api/">API Level 15</a></td>
                <td style="text-align:center">net8.0-tizen11.0</td>
                <td style="text-align:center">Tizen vNext</td>
                <td style="text-align:center"></td>
            </tr>
            <tr>
                <td style="text-align:center"><a href="./API14/api/">API Level 14</a></td>
                <td style="text-align:center">net8.0-tizen10.1</td>
                <td style="text-align:center">Tizen 10.1 (TV)</td>
                <td style="text-align:center"></td>
            </tr>
            <tr>
                <td style="text-align:center"><a href="./API13/api/">API Level 13</a></td>
                <td style="text-align:center">net8.0-tizen10.0</td>
                <td style="text-align:center">Tizen 10.0</td>
                <td style="text-align:center"><a href="https://www.nuget.org/packages/Tizen.NET/"><img src="https://img.shields.io/nuget/v/Tizen.NET.API13.svg" alt="api12_nuget"></a></td>
            </tr>
            <tr>
